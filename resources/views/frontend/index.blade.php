  ...
  <div class="container">
    <div class="row my-2">
      ...
      <div class="box col-md-4 m-md-4 col-sm-5 m-sm-3 col-lg-2 mx-lg-3  my-sm-3 my-md-2 my-lg-2 my-4 px-0" style="border-radius: 0;">
        <div class="">
  ...
  <div class="container my-3">
    <div class="row">
      ...
      @php $photos = json_decode($item->photo) @endphp
      <div class="box col-md-4 m-md-4 col-sm-5 m-sm-3 col-lg-2 mx-lg-3  my-sm-3 my-md-2 my-lg-2 my-4 px-0">
        <div class="">
          <a href="{{route('shopdetail',$item->id)}}"><img src="{{asset($photos[0])}}" class="img-fluid" alt="..."></a>
        </div>
        <div class="card-body">
